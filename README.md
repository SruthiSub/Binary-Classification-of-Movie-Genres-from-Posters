...
**Libraries Used** - stringr, rvest, imager and glmnet

**Results from Testing** - Obtained 81.67% accuracy on testing dataset!

**Reproduction Guidelines**

- All results can be reproduced by running the given files (just make sure that you change the paths in the code, to ensure compatibility with your local system).
